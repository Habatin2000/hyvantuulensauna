        ...
        <div className="grid gap-8 md:grid-cols-2 lg:grid-cols-4">
          ...
          <div className="lg:col-span-1">
            <Link href="/" className="flex items-center gap-3">
              ...
              <span className="font-pacifico text-lg text-white/90">
                Hyvän Tuulen Sauna
              </span>
            </Link>
            ...
            <div className="mt-6 flex gap-3">
              <a 
                href={footerNavigation.social.instagram}
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 shadow-sm transition-colors hover:bg-white/20 hover:text-white"
              ...
              <a 
                href={footerNavigation.social.facebook}
                target="_blank"
                rel="noopener noreferrer"
                className="flex h-10 w-10 items-center justify-center rounded-full bg-white/10 text-white/80 shadow-sm transition-colors hover:bg-white/20 hover:text-white"
                aria-label="Facebook"
